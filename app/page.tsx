...
export default function Page() {
  ...
  return <main>
    ...
    {menu && <div className="mobile-menu"><a href="#work" onClick={() => setMenu(false)}>Work</a><a href="#about" onClick={() => setMenu(false)}>About</a><a href="#services" onClick={() => setMenu(false)}>Services</a><a href="/blog">Journal</a><a href="#contact" onClick={() => setMenu(false)}>Contact</a><p>Available for a good prompt.</p></div>}
